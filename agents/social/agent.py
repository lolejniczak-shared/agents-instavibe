...
profile_agent = LlmAgent(
    ...
    description=(
        """Agent to answer questions about the this person's social profile. 
        User will ask person's profile using their name, make sure to fetch the id before getting other data."""
    ),
    instruction=(
